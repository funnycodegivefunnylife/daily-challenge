...
public class TestLRUCache {
    ...
    public void testLRUCache() {
        ...
        List<List<Integer>> parameters = Arrays.asList(List.of(1, 1), List.of(2, 2), List.of(1), List.of(3, 3), List.of(2), List.of(4, 4), List.of(1), List.of(3), List.of(4));
    ...
    public void testLRUCache2() {
        ...
        List<List<Integer>> parameters = Arrays.asList(List.of(2), List.of(2, 6), List.of(1), List.of(1, 5), List.of(1, 2), List.of(1), List.of(2));
