...
class SolutionTest {
    ...
    @Test
    public void test2() {
        List<Integer> nums = List.of(18,31,18,22,14,27,19,28,4,33,33,17,44,16,20,8,40,5,42,4,26,19,23,15,24,32,29,1,2,30,22,46,10,12,6,32,35,13,30,21,46,11,25,7,3,11,34,9,15,28);
